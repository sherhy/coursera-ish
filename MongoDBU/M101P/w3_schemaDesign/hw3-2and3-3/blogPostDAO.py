...
class BlogPostDAO:
    ...
    def add_comment(self, permalink, name, email, body):
        ...
        try:
            ...
            #When done, modify the line below to return the number of documents updated by your 
            #modification, rather than just -1.
            ...
            return self.db.runCommand({'getLastError':1})['n'] # Change this to return the number of documents updated by the code for HW 3.3
